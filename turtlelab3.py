...
class Task:
    """
    TASK: help guide Turtle home quickly by taking the shortest path possible.
    NOTES: Home will randomly appear in Quadrant 1 every time the task starts
    """
    def start(self):
        stage.reset()
        stage.turtle.pos_changed_callbacks.append(self.pos_changed)
        self.home = Home(randint(100,300),randint(100,300),32,32,IMG_HOME)
    ...
    def done(self):
        ...
        if self.home.contains(stage.turtle):
            ...
            shortest = sqrt(self.home.x**2 + self.home.y**2)
